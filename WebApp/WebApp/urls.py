...
urlpatterns = [
	...
	url(r'^AdminRemoveGroup/$',AdminGroupRemove),
    ...
    url(r'^StartPageSave/$',StartPageSave),
    url(r'^StartPageRemoveFriendship/$',StartPageRemoveFriendship),
    url(r'^GroupApp/$',GroupApp),
    url(r'^GroupsApp/$',Groups),
    url(r'^AddCommentApp/$',AddCommentApp),
    url(r'^AdminNewComment/$',AdminNewComment),
    url(r'^AdminRemoveComment/$',AdminCommentRemove),
    url(r'^oauth2callback/$',UploadDropbox),
    url(r'^AdminRemoveFriendship/$',AdminRemoveFriendship),
    url(r'AdminNewFriendshipRequest/$',AdminNewFriendshipRequest),
    url(r'AdminRemoveFriendshipRequest/$',AdminRemoveFriendshipRequest),
